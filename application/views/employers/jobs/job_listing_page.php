  ...
  <div class="container">
    <div class="row justify-content-center d-flex">
      ...
      <div class="col-lg-8 post-list">
        ...
        <div class="Active Jobs-job-alerts">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    ?>
                    <a href="<?= base_url('employers/job/delete/'.$job['id']); ?>" class="Active Jobs-savedjobs-links btn-delete"><i title="<?=trans('delete')?>" class="lnr lnr-trash"></i></a>
                    <a href="<?= base_url('employers/job/edit/'.$job['id']); ?>" class="Active Jobs-savedjobs-links"><i title="<?=trans('edit')?>" class="lnr lnr-pencil"></i></a>
                    <a href="<?= base_url('employers/job/edit/'.$job['id']); ?>" class="Active Jobs-savedjobs-links"><i title="<?=trans('view')?>" class="lnr lnr-eye"></i></a>
                  </td>
                </tr>
                <?php endforeach; ?>
              </tbody>
